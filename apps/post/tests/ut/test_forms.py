...
from apps.post.form import NewPost
from apps.post.models import Tag, Category


class TestNewPostForm(TestCase):
    def setUp(self):
        self.cat = Category.objects.create(cat="Testcategory")
    ...
    def test_form_is_valid_method_return_true_for_good_data(self):
        ...
        # ACT
        form = NewPost(data=data, files={'image': image})

        # ASSERT
        self.assertTrue(form.is_valid())
        
    def test_form_not_valid_if_image_missing(self):
        data = {
